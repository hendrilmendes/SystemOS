                ...
                <form class="user" method="POST" name="form_edit">
                    ...
                    <fieldset class="mt-4 border p-2">
                        ...
                        <div class="col-md-6">
                                <?php if ($cliente->cliente_tipo == 1): ?>
                                    <label>Nome</label>
                                    <input type="text" class="form-control form-control-user" name="cliente_nome" placeholder="<?php echo ($cliente->cliente_tipo == 1 ? 'Nome do Cliente' : 'Razão Social do Cliente') ?>" value="<?php echo $cliente->cliente_nome; ?>">
                            ...
                            <div class="col-md-6">
                                ...
                                <?php endif; ?>
                                <input type="text" class="form-control form-control-user" name="cliente_sobrenome" placeholder="<?php echo ($cliente->cliente_tipo == 1 ? 'Sobrenome do Cliente' : 'Fantasia do Cliente') ?>" value="<?php echo $cliente->cliente_sobrenome; ?>">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="tel" class="form-control form-control-user sp_celphones" name="cliente_telefone" placeholder="Telefone Fixo" value="<?php echo $cliente->cliente_telefone; ?>">
                                <?php echo form_error('cliente_telefone', '<small class="form-text text-danger">', '</small>'); ?>
                            </div>

                            <div class="col-md-6">
                                <label>Telefone Celular</label>
                                <input type="tel" class="form-control form-control-user sp_celphones" name="cliente_celular" placeholder="Celular do cliente" value="<?php echo $cliente->cliente_celular; ?>">
                    ...
                    <fieldset class="mt-4 border p-2">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-2">
                                <label>Número</label>
                                <input type="number" min="1" max="9999" class="form-control form-control-user" name="cliente_numero_endereco" value="<?php echo $cliente->cliente_numero_endereco; ?>">
